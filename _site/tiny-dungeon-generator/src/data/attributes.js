...
export const backstory = [
  ...
  "finds it impossible to speak to human men",
...
export const generateAttributes = () => {
  return {
    adjective: randPick(adjective),
    homeland: randPick(homeland),
    belief: randPick(beliefs),
    backstory: randPick(backstory),
    trade: randPick(trades)
  }
}
